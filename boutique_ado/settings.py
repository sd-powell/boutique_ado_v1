...
SECRET_KEY = 'django-insecure-!w9irrsh51e!w@vqvx-73hv40g92n$x7@oevpaulpo5eed5_w='
...
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # Default for admin/superuser
...
ACCOUNT_EMAIL_CONFIRMATION_REQUIRED = True         # Require confirmation for registration
